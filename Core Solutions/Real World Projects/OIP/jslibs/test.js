  ...
  var SEPARATOR = "|||";
  var test, tp1, tp2, tp3;
  var SLASH = "/";

  function WaitForCalendarToLoad() {
      test = new String(window.location);
      //tp1 = test.indexOf("sites");
      tp1 = test.indexOf("Lists");
      tp1 = test.substring(0, tp1);
      //tp2 = tp1 + "sites" + SLASH + "tec";
      tp2 = tp1; //+ "Lists" + SLASH; //+ "Colors";(communicate with Colors list)
      console.log(tp2);
...
function ColorCalendar() {
    if (jQuery('a:contains(' + SEPARATOR + ')') != null) {
        ...
        if (colorCodes == null)
            alert('The color category list is empty.');
